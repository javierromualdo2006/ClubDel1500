        ...
        <div className="max-w-7xl mx-auto p-3 sm:p-4 lg:p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              {isAdmin() && (
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="w-[95vw] max-w-md mx-auto overflow-y-scroll max-h-[80vh]">
                    <DialogHeader>
                    ...
                    <div className="space-y-4 pt-4 ">
                      ...
                      <div>
                        <Label htmlFor="url_MercadoLibre" className="text-sm">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              url_MercadoLibre: e.target.value,
                            })
                          }
                      ...
                      <div>
                        <Label htmlFor="url_img" className="text-sm">
                        ...
                        {formData.url_img && (
                          <div className="mt-2">
                            ...
                            <img
                              ...
                              onError={(e) => {
                                e.currentTarget.src =
                                  "/placeholder.svg?height=120&width=120&text=Error";
                              }}
                            />
                          </div>
                        )}
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button
                          ...
                          className="bg-[#004386] hover:bg-[#005ea6] flex-1 text-sm"
                        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4 pb-8">
            {filteredProducts.map((product) => (
              <Card
                key={product.id}
                className="bg-[#d9d9d9] hover:shadow-lg transition-all duration-200"
              >
                <CardContent className="p-3">
                  <div className="aspect-square bg-white rounded-lg mb-2 overflow-hidden">
                    {product.url_img ? (
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src =
                            "/placeholder.svg?height=150&width=150&text=Producto";
                        }}
                      />
                    ) : (
                  ...
                  <p className="text-sm sm:text-base font-bold text-[#004386] mb-2">
                    ${product.price}
                  </p>
                  ...
                  {product.url_MercadoLibre && (
                    <div className="mb-2">
                      <Button
                        ...
                        onClick={() =>
                          window.open(product.url_MercadoLibre, "_blank")
                        }
                      >
                        Ver en ML
                      </Button>
